...
static opt_t options_master[] = {
	...
	"flag is not set, encryption will be done by xoring the plaintext with "
	"a sequence generated by a pseudo random number generator (RNG). the "
	"seed of the sequence will be randomly generated and only it will be "
	"RSA encrypted. this switch implies encryption"},
    {RSA_OPT_CBC, 'c', "cbc", no_argument, "full RSA encryption using Cipher "
	"Block Chaining (CBC) cipher mode. by default Electronic Codebook "
	"(ECB) is used"},
